...
describe('Plane Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'plane', component: PlaneComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.planes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
