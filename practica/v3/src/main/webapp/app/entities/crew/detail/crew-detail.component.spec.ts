...
describe('Crew Management Detail Component', () => {
  let comp: CrewDetailComponent;
      ...
      providers: [
        {
          ...
          useValue: { data: of({ crew: { id: 123 } }) },
        },
      ],
    })
      .overrideTemplate(CrewDetailComponent, '')
      .compileComponents();
  ...
  describe('OnInit', () => {
    it('Should load crew on init', () => {
      ...
      // THEN
      expect(comp.crew).toEqual(expect.objectContaining({ id: 123 }));
    });
  });
