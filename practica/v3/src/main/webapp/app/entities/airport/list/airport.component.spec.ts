...
describe('Airport Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'airport', component: AirportComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.airports?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
