...
describe('Pilot Management Component', () => {
  let comp: PilotComponent;
  let fixture: ComponentFixture<PilotComponent>;
  let service: PilotService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'pilot', component: PilotComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(PilotComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.pilots?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
